...
const API_URL = 'http://ec2-54-165-226-79.compute-1.amazonaws.com:3000/api'; // Replace with your backend URL
...
async function processNextInQueue() {
    ...
    try {
        ...
        const response = await axios.post(
            ...
            'http://ec2-54-165-226-79.compute-1.amazonaws.com:3000/imageModel/remove-background',
            formData,
            {
                headers: {
                    'Authorization': `Bearer ${data.token}`,
...
ipcMain.on('remove-human', async (event, data) => {
    ...
    const processNextInQueue = async () => {
        ...
        try {
            ...
            // If not cached, make request to backend
            const response = await axios.post(
                'http://ec2-54-165-226-79.compute-1.amazonaws.com:3000/imageModel/remove-human',
                formData,
                {
                    headers: {
                        'Authorization': `Bearer ${data.token}`,
